...
export interface GameInfo {
  ...
  textColor: string
  pokedexId: string | number | (string | number)[]
...
export const GAMES: GameInfo[] = [
  ...
  // Geração II
  { slug: 'gold-silver',        name: 'Gold / Silver',           generation: 2, color: '#B8860B', color2: '#64748B', textColor: '#fff', pokedexId: 3,  coverPokemon: [250, 249]   }, // Ho-Oh, Lugia
  { slug: 'crystal',            name: 'Crystal',                 generation: 2, color: '#0EA5E9', textColor: '#fff', pokedexId: 3,  coverPokemon: [245]        }, // Suicune
  // Geração III
  { slug: 'ruby-sapphire',      name: 'Ruby / Sapphire',         generation: 3, color: '#B91C1C', color2: '#1E3A8A', textColor: '#fff', pokedexId: 4, coverPokemon: [383, 382]   }, // Groudon, Kyogre
  { slug: 'emerald',            name: 'Emerald',                 generation: 3, color: '#15803D', textColor: '#fff', pokedexId: 4, coverPokemon: [384]        }, // Rayquaza
  ...
  // Geração IV
  { slug: 'diamond-pearl',      name: 'Diamond / Pearl',         generation: 4, color: '#4F46E5', color2: '#BE185D', textColor: '#fff', pokedexId: 5, coverPokemon: [483, 484]   }, // Dialga, Palkia
  { slug: 'platinum',           name: 'Platinum',                generation: 4, color: '#475569', textColor: '#fff', pokedexId: 6, coverPokemon: [487]        }, // Giratina
  ...
  // Geração V
  { slug: 'black-white',        name: 'Black / White',           generation: 5, color: '#1C1917', color2: '#94A3B8', textColor: '#fff', pokedexId: 8, coverPokemon: [643, 644]   }, // Reshiram, Zekrom
  { slug: 'black-2-white-2',    name: 'Black 2 / White 2',       generation: 5, color: '#111827', color2: '#9CA3AF', textColor: '#fff', pokedexId: 9, coverPokemon: [10022, 10023] }, // Kyurem-Black, Kyurem-White
  // Geração VI
  { slug: 'x-y',                mechanics: [{ label: 'Mega Evolução', formFilter: 'mega' }],                name: 'X / Y',                  generation: 6, color: '#1D4ED8', color2: '#BE123C', textColor: '#fff', pokedexId: [12, 13, 14], coverPokemon: [716, 717]   }, // Xerneas, Yveltal
  ...
  // Geração VII
  { slug: 'sun-moon',           mechanics: [{ label: 'Z-Moves' }],           name: 'Sun / Moon',              generation: 7, color: '#D97706', color2: '#4C1D95', textColor: '#fff', pokedexId: 16, coverPokemon: [791, 792]   }, // Solgaleo, Lunala
  ...
  { slug: 'brilliant-diamond-shining-pearl', name: 'B. Diamond / S. Pearl', generation: 10, color: '#4F46E5', color2: '#DB2777', textColor: '#fff', pokedexId: 5, coverPokemon: [483, 484], noEncounterData: true }, // Dialga, Palkia
